...
fmWhere tells fmpy2 where you want to do the needful - server, solution name, layout name, the action you want to do, and a couple of options about how you get the data back. See below.

fmWhat tells fmpy2 what you want to do with the action in fmWhere - in its most basic form you have a pk key and a uuid key but there's other options (see below)
